...
<head>
    ...
    <title>Online BookShop : Book-View</title>
...
<body>
    ...
    <div class="um" id="show">
        ...
        foreach ($data as $row) {
            ...
            $path = $row["path"];
        ?>
            <form action="book_gen.php" method="post">
                <div class="row" style="width: 50%; margin: 0 auto; margin-bottom: 40px;">
                    ...
                    <div class="col-md-5">
                        ...
                        <button type="submit" value="submit"  class="btn btn-primary">You Can Generate Your reporte</button>
